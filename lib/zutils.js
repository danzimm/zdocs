...
var artist = (function() {
    ...
    that.createPage = function(title, options) {
        ...
        page.prependScript = function(script) {
            if (this.options.scripts) {
                this.options.scripts.splice(0,0,script);
            } else {
                this.options.scripts = [script];
            }
            return this;
        };
        page.appendScript = function(script) {
            if (this.options.scripts) {
        ...
        page.render = function() {
            ...
            header.enumerate(function(key, object, index, dict) {
                acat.addItem(dominie.createItem("text", {
                    title : key,
                    text : "<div class=\"headercontent\">" + object.content + "</div>"
                }));
            });
