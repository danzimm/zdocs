...
module.exports = (function() {
    ...
    that.stackDoc = function(app, p, arg) {
        if(arg.stylesheets) {
            arg.stylesheets.push(path.resolve(p, "stylesheets/style.css"));
        } else {
            arg.stylesheets = [path.resolve(p, "stylesheets/style.css")];
        }
        if (arg.scripts) {
            arg.scripts.push(path.resolve(p,"js/main.js"));
        } else {
            arg.scripts = [path.resolve(p,"js/main.js")];
        }
        arg.path = p;
